 ...
 */
export function adjustValue(val, perc) {
 ...
 */
export function calculateMaxFee(baseFee, maxPriorityFee) {
 ...
 */
export function estimateImportGasFeeFromMockTx(numIns = 1, numSigs // number of signatures (sum of owner addresses in each utxo)
) {
 ...
 */
export function estimateExportGasFeeFromMockTx(destinationChain, amount, from, to) {
 ...
 */
export async function estimateExportGasFee(destinationChain, from, fromBech, to, amount) {
