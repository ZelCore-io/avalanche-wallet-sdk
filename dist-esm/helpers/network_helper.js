...
export function wsUrlFromConfigEVM(config) {
    let protocol = config.apiProtocol === 'http' ? 'ws' : 'wss';
 ...
 */
export async function getNetworkIdFromURL(url) {
...
export function createAvalancheProvider(config) {
 ...
 */
export function createExplorerApi(networkConfig) {
 ...
 */
export async function canUseCredentials(config) {
