 ...
 */
export function isOutputOwner(ownerAddrs, output) {
...
export function isOutputOwnerC(ownerAddr, output) {
 ...
 */
export function getAssetBalanceFromUTXOs(utxos, addresses, assetID, chainID, isStake = false) {
 ...
 * @param isStake Set to `true` if looking for staking utxos.
 */
export function getEvmAssetBalanceFromUTXOs(utxos, address, assetID, chainID, isStake = false) {
    let myOuts = utxos.filter((utxo) => {
        if (assetID === utxo.assetID &&
 ...
 */
export function getOutputsOfChain(outs, chainID) {
 ...
 */
export function getOutputsOfType(outs, type) {
 ...
 * @param outs
 */
export function getOutputsAssetOwners(outs) {
 ...
 */
export function getOutputsAssetIDs(outs) {
    let res = [];
    for (let i = 0; i < outs.length; i++) {
        let out = outs[i];
