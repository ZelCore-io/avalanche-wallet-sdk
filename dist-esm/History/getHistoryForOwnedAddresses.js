...
export async function getHistoryP(addrs, limit = 0) {
 ...
 * @param limit
 */
export async function getHistoryC(addrC, addrsX, limit = 0) {
 ...
 */
export async function getHistoryEVM(addr) {
 ...
 * @param limit
 */
export async function getHistoryForOwnedAddresses(xAddresses, pAddresses, cAddress, evmAddress, limit = 0) {
 ...
 */
export async function getHistoryForOwnedAddressesRaw(xAddresses, pAddresses, cAddress, limit = 0) {
    let [txsX, txsP, txsC] = await Promise.all([
        getHistoryX(xAddresses, limit),
        getHistoryP(pAddresses, limit),
        getHistoryC(cAddress, xAddresses, limit),
