...
export declare type OrteliusTransactionType = 'base' | 'create_asset' | 'operation' | 'import' | 'export' | 'add_validator' | 'add_subnet_validator' | 'add_delegator' | 'create_chain' | 'create_subnet' | 'pvm_import' | 'pvm_export' | 'atomic_import_tx' | 'atomic_export_tx' | 'advance_time' | 'reward_validator';
export {};
